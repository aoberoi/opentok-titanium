...
*  Because you cannot test the module using `titanium run`, there is an example app in a separate repo.
   To use this app, first run build.py as seen above, copy the zip file left behind into 
