 ...
 *
 * On instantiation, expect the `sessionConnectionStatus` to have the value `kSessionConnectionStatus_Disconnected`.
 *
...
/**
 * The streams that are a part of this session.
 */
@property(readonly, retain) NSMutableDictionary* streams;
